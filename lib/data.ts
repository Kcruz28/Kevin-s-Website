...
export const projects: Project[] = [
  {
    ...
    name: "WebSight",
    blurb:
      "Render-to-text feedback for accessible website creation. Built the LLM describer module that turns DOM and accessibility-tree snapshots into plain-language page descriptions and what-changed summaries, letting blind and low-vision creators iterate without visual inspection.",
    stack: ["Python", "FastAPI", "Playwright", "axe-core", "LLM"],
    year: "2026",
    cmd: "uvicorn websight.server:app --port 8765",
    href: "https://github.com/shraddhaamohan/cs568-final-project",
    glow: "#d4ff3a",
    category: "AI & Agents",
  },
  {
    ...
    year: "2026",
    cmd: "langgraph run research_swarm --brief",
  ...
  },
  {
    ...
    year: "2024",
    cmd: "./gradlew :spring-cloud-gateway:test",
  ...
  },
  {
    ...
    year: "2026",
    cmd: "kubectl get deploy,pods -o wide",
  ...
  },
  {
    ...
    year: "2026",
    cmd: "python automl/train.py --tune",
    href: "https://github.com/Kcruz28",
    glow: "#d4ff3a",
    category: "Cloud Systems",
  },
  {
    ...
    year: "2026",
    cmd: "spark-submit pagerank.py --iter 10",
    href: "https://github.com/Kcruz28",
    glow: "#ff4d2e",
    category: "Cloud Systems",
  },
  ...
  },
  {
    ...
    year: "2026",
    cmd: "flink run -c StreamJob streaming.jar",
    href: "https://github.com/Kcruz28",
    glow: "#d4ff3a",
    category: "Cloud Systems",
  },
  ...
  },
  {
    ...
    year: "2026",
    cmd: "kafka-topics --create --topic events",
    href: "https://github.com/Kcruz28",
    glow: "#d4ff3a",
    category: "Cloud Systems",
  },
  ...
  },
  {
    ...
    year: "2026",
    cmd: "aws lambda invoke --fn QueryHandler",
    href: "https://github.com/Kcruz28",
    glow: "#d4ff3a",
    category: "Cloud Systems",
  },
  {
    ...
    year: "2026",
    cmd: "aws autoscaling describe-groups",
    href: "https://github.com/Kcruz28",
    glow: "#ff4d2e",
    category: "Cloud Systems",
  },
  ...
  },
  {
    ...
    year: "2023",
    cmd: "curl /api/events?market=chicago",
